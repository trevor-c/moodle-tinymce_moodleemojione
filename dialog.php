...
/**
 * Displays the TinyMCE popup window to insert emojione
 *
 * @package   tinymce_moodleemojione
 * @copyright 2016 Trevor Cunningham <trevor_c@me.com>
...
$PAGE->set_url('/lib/editor/tinymce/plugins/moodleemojione/dialog.php');

$editor = get_texteditor('tinymce');
$plugin = $editor->get_plugin('moodleemojione');
...
<head>
    <title><?php print_string('moodleemojione:desc', 'tinymce_moodleemojione'); ?></title>
    ...
    <script type="text/javascript" src="<?php echo $plugin->get_tinymce_file_url('../../../../../../emojione/lib/js/emojione.min.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo $plugin->get_tinymce_file_url('../../../../../../emojione/lib/js/emojiUnitoShort.js'); ?>"></script>
	<link rel="stylesheet" id="wp_emoji-css"  href="<?php echo $plugin->get_tinymce_file_url('css/emojione-style.css'); ?>" type="text/css" media="all" />
	<base target="_self" />

	<script language="javascript" type="text/javascript" src="<?php echo $plugin->get_tinymce_file_url('js/InsertEmoji.js'); ?>"></script>
</head>
<body id="link" onload="tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';" style="display: none">
  ...
  <label for="tab1" title="<?php get_string('moodleemojione:people_desc','tinymce_moodleemojione'); ?>"><img src="<?php echo $plugin->get_tinymce_file_url('img/smiley.png'); ?>" alt="" /></label>
  <input id="tab2" type="radio" name="tabs">
  <label for="tab2" title="<?php get_string('moodleemojione:natureanimals_desc','tinymce_moodleemojione'); ?>"><img src="<?php echo $plugin->get_tinymce_file_url('img/flower.png'); ?>" alt="" /></label>
  <input id="tab3" type="radio" name="tabs">
  <label for="tab3" title="<?php get_string('moodleemojione:fooddrink_desc','tinymce_moodleemojione'); ?>"><img src="<?php echo $plugin->get_tinymce_file_url('img/apple.png'); ?>" alt="" /></label>
  <input id="tab4" type="radio" name="tabs">
  <label for="tab4" title="<?php get_string('moodleemojione:celebration_desc','tinymce_moodleemojione'); ?>"><img src="<?php echo $plugin->get_tinymce_file_url('img/bow.png'); ?>" alt="" /></label>
  <input id="tab5" type="radio" name="tabs">
  <label for="tab5" title="<?php get_string('moodleemojione:activity_desc','tinymce_moodleemojione'); ?>"><img src="<?php echo $plugin->get_tinymce_file_url('img/swim.png'); ?>" alt="" /></label>
    <input id="tab6" type="radio" name="tabs">
    <label for="tab6" title="<?php get_string('moodleemojione:travelplaces_desc','tinymce_moodleemojione'); ?>"><img src="<?php echo $plugin->get_tinymce_file_url('img/car.png'); ?>" alt="" /></label>
  <input id="tab7" type="radio" name="tabs">
  <label for="tab7" title="<?php get_string('moodleemojione:objectssymbols_desc','tinymce_moodleemojione'); ?>"><img src="<?php echo $plugin->get_tinymce_file_url('img/clock.png'); ?>" alt="" /></label>
  <hr><br />
    ...
    <span class="size-box">
		<label for="icon-size"><?php get_string('moodleemojione:size_desc', 'tinymce_moodleemojione'); ?></label></th>
            ...
            <em><?php get_string('moodleemojione:iconimgsize_desc', 'tinymce_moodleemojione'); ?></em><br/>
	</span>
...
<div style="float: right; margin:5px 35px 0 0;">
    ...
    <script type="text/javascript">
        //<![CDATA[
        var meo_emojionedomain = "<?php echo $plugin->get_tinymce_file_url(); ?>";
